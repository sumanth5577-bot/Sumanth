...
/**
 * This is the extension manager of the Kb2b extension.
 */
public class Kb2bManager extends GeneratedKb2bManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Kb2bManager.class);
	 ...
	 */
	public static Kb2bManager getInstance()
	{
		return (Kb2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Kb2bConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Kb2bManager() // NOPMD 
	{
		LOG.debug("constructor of Kb2bManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Kb2bManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Kb2bManager called, current tenant: {}", getTenant().getTenantID());
	}
