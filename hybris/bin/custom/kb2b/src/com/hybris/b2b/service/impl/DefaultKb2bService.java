...
public class DefaultKb2bService implements Kb2bService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultKb2bService.class);
	...
	{
		return DefaultKb2bService.class.getResourceAsStream("/kb2b/sap-hybris-platform.png");
	}
