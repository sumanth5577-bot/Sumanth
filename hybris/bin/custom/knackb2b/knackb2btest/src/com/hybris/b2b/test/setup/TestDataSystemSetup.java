 ...
 */
package com.hybris.b2b.test.setup;
...
import com.hybris.b2b.test.constants.Knackb2bTestConstants;
import com.hybris.b2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Knackb2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/knackb2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/knackb2btest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/knackb2btest/import/cstickets.impex");
			...
			importImpexFile(context, "/knackb2btest/import/csquotes.impex");
		}
	}
}
