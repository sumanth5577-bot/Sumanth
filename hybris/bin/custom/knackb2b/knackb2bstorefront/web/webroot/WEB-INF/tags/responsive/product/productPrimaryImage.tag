...
<!-- bharath media management changes -->
<c:set value="${product.extMediaImgUrlList.thumbnail}" var="prodExtImg" />
...
<c:choose>
	<c:when test="${not empty prodExtImg}">
		<img src="${prodExtImg}" alt="${altText}" title="${altText}"/>
	</c:when>
