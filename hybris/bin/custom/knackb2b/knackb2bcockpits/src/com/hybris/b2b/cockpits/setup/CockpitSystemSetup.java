 ...
 */
package com.hybris.b2b.cockpits.setup;
...
import com.hybris.b2b.cockpits.constants.Knackb2bCockpitsConstants;
 ...
 */
@SystemSetup(extension = Knackb2bCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(Knackb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(Knackb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						Knackb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/knackb2bcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
